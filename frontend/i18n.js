(function (root, factory) {
  ...
  const TRANSLATIONS = {
    it: {
      ...
      statusStep1: "Stiamo leggendo il documento...",
      statusStep2: "Stiamo individuando i punti di attenzione...",
      statusStep3: "Stiamo scrivendo la spiegazione...",
      extractedTextHeading: "Testo estratto",
      analysisHeading: "Analisi",
      analysisPlaceholder: "Premi «Analizza» per generare la spiegazione dell'IA.",
      ...
      originalDocumentHeading: "Documento originale",
      generatedReportHeading: "Report generato",
      ...
      docsToggle: "Documentazione",
      docsPanelTitle: "Come è fatto",
      docsRepoLink: "Vedi il codice su GitHub",
      docReadme: "Cos'è",
      docOverview: "Come funziona",
      docLimitations: "Limiti noti",
      examplesLabel: "Non hai un file sottomano? Prova con:",
      exampleLease: "Contratto di locazione",
      exampleMemo: "Email di lavoro",
      exampleCv: "Un CV",
    ...
    en: {
      ...
      statusStep1: "Reading the document...",
      statusStep2: "Identifying points of attention...",
      statusStep3: "Writing the explanation...",
      extractedTextHeading: "Extracted text",
      analysisHeading: "Analysis",
      analysisPlaceholder: "Press “Analyze” to generate the AI explanation.",
      ...
      generatedReportHeading: "Generated report",
      ...
      docsPanelTitle: "How it's built",
      docsRepoLink: "See the code on GitHub",
      docReadme: "What this is",
      docOverview: "How it works",
      docLimitations: "Known limitations",
      examplesLabel: "No file at hand? Try one of these:",
      exampleLease: "Lease contract",
      exampleMemo: "Work email",
      exampleCv: "A CV",
    ...
    fr: {
      ...
      statusStep1: "Lecture du document...",
      statusStep2: "Identification des points d'attention...",
      statusStep3: "Rédaction de l'explication...",
      extractedTextHeading: "Texte extrait",
      analysisHeading: "Analyse",
      analysisPlaceholder: "Appuyez sur « Analyser » pour générer l'explication de l'IA.",
      summaryLabel: "Résumé",
      ...
      originalDocumentHeading: "Document original",
      generatedReportHeading: "Rapport généré",
      ...
      docsToggle: "Documentation",
      docsPanelTitle: "Comment c'est fait",
      docsRepoLink: "Voir le code sur GitHub",
      docReadme: "Ce que c'est",
      docOverview: "Comment ça marche",
      docLimitations: "Limites connues",
      examplesLabel: "Pas de fichier sous la main ? Essayez :",
      exampleLease: "Contrat de location",
      exampleMemo: "E-mail professionnel",
      exampleCv: "Un CV",
    ...
    de: {
      ...
      statusStep1: "Dokument wird gelesen...",
      statusStep2: "Auffälligkeiten werden identifiziert...",
      statusStep3: "Erklärung wird verfasst...",
      extractedTextHeading: "Extrahierter Text",
      analysisHeading: "Analyse",
      analysisPlaceholder: "Klicken Sie auf „Analysieren“, um die KI-Erklärung zu erzeugen.",
      ...
      originalDocumentHeading: "Originaldokument",
      generatedReportHeading: "Erstellter Bericht",
      ...
      docsToggle: "Dokumentation",
      docsPanelTitle: "Wie es gebaut ist",
      docsRepoLink: "Den Code auf GitHub ansehen",
      docReadme: "Was das ist",
      docOverview: "Wie es funktioniert",
      docLimitations: "Bekannte Grenzen",
      examplesLabel: "Keine Datei zur Hand? Probieren Sie:",
      exampleLease: "Mietvertrag",
      exampleMemo: "Arbeits-E-Mail",
      exampleCv: "Ein Lebenslauf",
    ...
    es: {
      ...
      statusStep1: "Leyendo el documento...",
      statusStep2: "Identificando puntos de atención...",
      statusStep3: "Redactando la explicación...",
      extractedTextHeading: "Texto extraído",
      analysisHeading: "Análisis",
      analysisPlaceholder: "Pulsa «Analizar» para generar la explicación de la IA.",
      ...
      originalDocumentHeading: "Documento original",
      generatedReportHeading: "Informe generado",
      ...
      docsToggle: "Documentación",
      docsPanelTitle: "Cómo está hecho",
      docsRepoLink: "Ver el código en GitHub",
      docReadme: "Qué es",
      docOverview: "Cómo funciona",
      docLimitations: "Limitaciones conocidas",
      examplesLabel: "¿No tienes un archivo a mano? Prueba con:",
      exampleLease: "Contrato de alquiler",
      exampleMemo: "Correo de trabajo",
      exampleCv: "Un CV",
